...
class Api(object):
  ...
  def VerifyCredentials(self):
    '''
        Returns true if username, password validate. False otherise.
        Always overrides the cache
    '''
    ...
    try:
        self._FetchUrl(url, parameters=parameters)
        return True
    except:
        return False
  ...
  def CreateFriendship(self, user, follow=True):
  ...
  def _FetchUrl(self,
    ...
    Args:
      ...
      files: sequence of (name, filename, value) tuples
